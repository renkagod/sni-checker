...
**Отказ от ответственности:** Данный инструмент предназначен исключительно для образовательных целей и ознакомления. Автор не несет ответственности за любой возможный ущерб или неправомерное использование данного скрипта.
...
## Особенности работы
Скрипт проверяет возможность установления TLS-соединения с вашим сервером, используя подмену SNI. Все рабочие домены автоматически сохраняются в файл `scan_out/working.txt`.
