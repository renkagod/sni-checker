...
Инструмент для проверки SNI. Данный скрипт был дополнен мною на основе исходника. Исходник не является моей разработкой и был взят из открытых источников в интернете.
